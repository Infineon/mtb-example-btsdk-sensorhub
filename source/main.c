 ...
 *              messages and initializes the Bluetooth stack.
 *
 * Features demonstrated:
 *              I2C communication, ADC Reading, Timers, Bluetooth LE advertisement,
 *              Bluetooth LE connection, and notifications.
 *
 *  Controls:
...
********************************************************************************
* Summary: Sets trace to PUART and register Bluetooth LE management event callback
*
* Parameters:
*   None
*
...
void application_start(void)
{
    ...
    /* Register call back and configuration with stack */
     if(WICED_BT_SUCCESS != wiced_bt_stack_init(ble_app_management_cback ,
